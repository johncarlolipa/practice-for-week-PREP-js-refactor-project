...
const bothStringsIncluded = (sentence, word1, word2) => {
  return (
    sentence.toLowerCase().includes(word1.toLowerCase()) &&
    sentence.toLowerCase().includes(word2.toLowerCase())
  );
};

console.log(bothStringsIncluded("Love me or hate me", "love", "hate"));
/*
  Original:
...
const productArray = (arr) => arr.reduce((a, b) => a * b, 1);
console.log(productArray([3, 4, 5]));
...
const fiveAndEleven = (num) => num % 5 === 0 && num % 11 === 0;
console.log(fiveAndEleven(21));
